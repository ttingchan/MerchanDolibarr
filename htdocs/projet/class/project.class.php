...
class Project extends CommonObject
{
     ...
     *
     * 	@param		int		$socid		To filter on a particular Companies
     ...
     * @param	int		$socid			0=No filter on Companies, id of Companies
    ...
    function getProjectsAuthorizedForUser($user, $mode=0, $list=0, $socid=0)
    {
        ...
        // Internal users must see project he is contact to even if project linked to a Companies he can't see.
