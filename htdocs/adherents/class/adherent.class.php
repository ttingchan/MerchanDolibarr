...
class Adherent extends CommonObject
{
    ...
    function setThirdPartyId($thirdpartyid)
    {
        ...
        // Remove link to Companies onto any other members
        if ($thirdpartyid > 0)
        {
        ...
        // Add link to Companies for current member
     ...
     * 	@param	int		$fk_soc		To load member from its link to Companies
