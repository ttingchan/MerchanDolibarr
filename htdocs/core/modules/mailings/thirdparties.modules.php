...
class mailing_thirdparties extends MailingTargets
{
	...
	var $desc="Companies (by categories)";
	var $require_admin=0;
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		// Select the Companies from category
	...
	function formFilter()
	{
		...
		// $sql.= " AND visible > 0";	// We ignore the property visible because Companies's categories does not use this property (only products categories use it).
