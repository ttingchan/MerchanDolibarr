 ...
 *	\brief      Parent class for Companies models of doc generators
 */
 ...
 *		\brief  	Parent class for Companies code generators
 */
abstract class ModeleThirdPartyCode
{
     ...
     *		@param	Societe		$soc		Companies object
 ...
 *		\brief  	Parent class for Companies accountancy code generators
 */
abstract class ModeleAccountancyCode
{
     ...
     *      @param	Translate	$langs		Object langs
     *      @param	societe		$objsoc		Object thirdparty
     *      @param	int			$type		Type of Companies (1:customer, 2:supplier, -1:autodetect)
     *      @return	string					Example
     */
    ...
    /**
     *  Set accountancy account code for a Companies into this->code
     *
     *  @param	DoliDB	$db             Database handler
     *  @param  Societe	$societe        Companies object
...
/**
 *	Create a document for Companies
 *
 *	@param	DoliDB		$db  			Database handler
 *	@param  Societe		$object			Object of Companies to use
