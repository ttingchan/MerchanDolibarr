 ...
 *       \ingroup    societe
 *       \brief      File of class to manage Companies code with elephant rule
 */
 ...
 *       \brief 		Class to manage Companies code with elephant rule
 */
class mod_codeclient_elephant extends ModeleThirdPartyCode
{
	...
	function info($langs)
	{
		...
		//$tooltip.=$langs->trans("GenericMaskCodes2");	Not required for Companies numbering
	 ...
	 * Return next value
	 *
	 * @param	Societe		$objsoc     Object Companies
	 ...
	 *	@param	Societe		$soc	Object Companies
