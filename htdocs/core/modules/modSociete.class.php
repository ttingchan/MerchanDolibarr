 ...
 *	\brief      Module to manage Companies (customers, prospects)
...
class modSociete extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->const[$r][3] = 'Module to control Companies codes';
		$this->const[$r][4] = 0;
		$r++;
...
*/
		...
		// Export list of Companies and attributes
		$r++;
		...
		// Import list of Companies and attributes
		$r++;
