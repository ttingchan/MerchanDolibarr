...
class Form
{
    ...
    /**
     *  Output html form to select a Companies
     *
     *	@param	string	$selected       Preselected type
     *	@param  string	$htmlname       Name of field in form
     *  @param  string	$filter         Optionnal filters criteras (example: 's.rowid <> x')
     *	@param	int		$showempty		Add an empty field
     * 	@param	int		$showtype		Show Companies type in combolist (customer, prospect or supplier)
     * 	@param	int		$forcecombo		Force to use combo box
    ...
    /**
     *	Return list of all contacts (for a Companies or all)
     *
     *	@param	int		$socid      	Id ot Companies or 0 for all
     ...
     *
     *    @param	string	$page        	Page
     *    @param	Societe	$societe		Companies
