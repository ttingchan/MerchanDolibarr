...
abstract class CommonObject
{
    ...
    /**
     *    	Load the Companies of object from id $this->socid into this->thirdpary
     *
     *		@return		int					<0 if KO, >0 if OK
     */
     ...
     * 									Array of id of Companies with at least one contact on project (if source=thirdparty)
     */
   ...
   /**
    ...
    function isObjectUsed($id)
    {
        ...
        {
            // Check if Companies can be deleted
            $nb=0;
	 ...
	 *	@param  string		$seller            	Object of seller Companies
	 *	@param  string  	$buyer             	Object of buyer Companies
	...
	function printObjectLines($action, $seller, $buyer, $selected=0, $dateSelector=0)
	{
		...
		// Description
		print '<td colspan="7">'.$langs->trans('Description').'</td>';
