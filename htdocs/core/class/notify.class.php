...
class Notify
{
     ...
     * 	@param	int		$socid		Id of Companies
    ...
    /**
     * Return number of notifications activated for action code and Companies
     *
    ...
    function send($action, $socid, $texte, $objet_type, $objet_id, $file="")
    {
        ...
        if ($result)
        {
            ...
            $i = 0;
            while ($i < $num)	// For each notification couple defined (Companies/actioncode)
            {
