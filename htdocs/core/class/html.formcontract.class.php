...
class FormContract
{
	...
	/**
	 *	Show a combo list with contracts qualified for a Companies
	 *
	 *	@param	int		$socid      Id Companies (-1=all, 0=only contracts not linked to a Companies, id=contracts not linked or linked to Companies id)
