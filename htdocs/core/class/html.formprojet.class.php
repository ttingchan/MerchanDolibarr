...
class FormProjets
{
	...
	/**
	 *	Show a combo list with projects qualified for a Companies
	 *
	 *	@param	int		$socid      	Id Companies (-1=all, 0=only projects not linked to a Companies, id=projects not linked or linked to Companies id)
