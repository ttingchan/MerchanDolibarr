 ...
 *	\ingroup    societe
 *	\brief      File for Companies class
 */
require_once DOL_DOCUMENT_ROOT.'/core/class/commonobject.class.php';


/**
 *	Class to manage Companies objects (customers, suppliers, prospects...)
 */
class Societe extends CommonObject
{
    ...
    /**
     *    Check properties of Companies are ok (like name, Companies codes, ...)
     *
     *    @return     int		0 if OK, <0 if KO
     */
    function verify()
    ...
    /**
     *      Update parameters of Companies
     *
    ...
    /**
     *    Load a Companies from database into memory
     *
     *    @param	int		$rowid			Id of Companies to load
     *    @param    string	$ref			Reference of Companies, name (Warning, this can return several records)
     *    @param    string	$ref_ext       	External reference of Companies (Warning, this information is a free field not provided by Dolibarr)
     *    @param    string	$ref_int       	Internal reference of Companies
     *    @param    string	$idprof1		Prof id 1 of Companies (Warning, this can return several records)
     *    @param    string	$idprof2		Prof id 2 of Companies (Warning, this can return several records)
     *    @param    string	$idprof3		Prof id 3 of Companies (Warning, this can return several records)
     *    @param    string	$idprof4		Prof id 4 of Companies (Warning, this can return several records)
    ...
    function fetch($rowid, $ref='', $ref_ext='', $ref_int='', $idprof1='',$idprof2='',$idprof3='',$idprof4='')
    {
        ...
        if ($resql)
        {
            ...
            {
                $this->error='Fetch no Companies found for id='.$rowid;
                dol_syslog($this->error, LOG_ERR);
                $result = -2;
            }
        ...
        // Use first price level if level not defined for Companies
    ...
    /**
     *    Delete a Companies from database and all its dependencies (contacts, rib...)
     *
     *    @param	int		$id     Id of Companies to delete
    ...
    /**
     *  Define Companies as a customer
     *
     *	@return		int		<0 if KO, >0 if OK
     */
     ...
     *  @return array       		Array of sales representatives of Companies
     */
    ...
    /**
     *    Return list of contacts emails existing for Companies
     *
    ...
    /**
     *    Return list of contacts mobile phone existing for Companies
     *
     *    @return     array       Array of contacts emails
     */
    ...
    /**
     *  Return list of contacts emails or mobile existing for Companies
     *
    ...
    /**
     *  Return if Companies is a company (Business) or an end user (Consumer)
     *
    ...
    function isACompany()
    {
        ...
        // Define if Companies is treated as company of not when nature is unknown
    ...
    /**
     *  Create a Companies into database from a member object
     *
     *  @param	Member	$member		Object member
     * 	@param	string	$socname	Name of Companies to force
